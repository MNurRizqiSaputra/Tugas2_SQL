SIMPLE SELECT WORKSHEET 2

Nama: Muhammad Nur Rizqi Saputra
Kelompok Mentor = 2 (Pak Fathan)
...
3. Tampilkan produk-produk televise
	SELECT * FROM produk WHERE nama LIKE '%televise%';
    Tapi jika keyword diganti TV
